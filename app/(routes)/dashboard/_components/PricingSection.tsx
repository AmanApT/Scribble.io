  ...
  return (
    <div>
      <div className=" mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <h1 className="mb-5 font-bold">Upgrade Plan</h1>
          ...
          <div className="rounded-2xl border border-indigo-600 p-6 shadow-sm ring-1 ring-indigo-600 sm:order-last sm:px-8 lg:p-12">
            ...
            <ul className="mt-6 space-y-2">
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700"> Unlimited files per team </span>
              </li>
          ...
          <div className="rounded-2xl border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
            ...
            <ul className="mt-6 space-y-2">
              <li className="flex items-center gap-1">
                ...
                <span className="text-gray-700"> 50 Files per team</span>
              </li>
